...
images = os.listdir(r'C:\Users\tasha\OneDrive\Desktop\verzeo major project\All Images')
for image in images:
    try:
                ...
                if c>ghmn and c<ghmx:
                    if d>yzmn and d<yzmx:
                         if e>pqmn and e<pqmx:
                             print("\ngiven image contains a human: " + image)
                ...
                if c>tumn and c<tumx:
                    if d>vwmn and d<vwmx:
                        if e>mnmn and e<mnmx:
                            print("\ngiven image contains a human: " + image)
#change the below path with path of your folder of all images
        files = [r'C:\Users\tasha\OneDrive\Desktop\verzeo major project\All Images''\\' + image]
        for f in files:
            shutil.move(f, 'humans')
            
   
    except:
        print("\nnot human or face not detected: " + image)
#change the below path with path of your folder of all images
        files = [r'C:\Users\tasha\OneDrive\Desktop\verzeo major project\All Images''\\' + image]
        for f in files:
